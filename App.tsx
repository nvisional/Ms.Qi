      ...
      <div className="relative z-10 w-full flex flex-col items-center">
          ...
          <AnimatePresence mode="wait">
            {viewState === 'ticket' ? (
              <motion.div 
                ...
                exit={{ opacity: 0, y: -10 }}
              >
                <h2 className="text-xs font-bold text-amber-500 uppercase tracking-[0.3em] mb-2">
                  The Outcome
                </h2>
                {/* 老师第一次看到的标题 */}
              ...
              <motion.div 
                ...
                exit={{ opacity: 0, y: -10 }}
              >
                <h2 className="text-xs font-bold text-emerald-400 uppercase tracking-[0.3em] mb-2">
                  Access Granted
                </h2>
                {/* 点开后的状态说明：给老师的小纸条 */}
                <h3 className="text-3xl md:text-4xl font-bold text-white tracking-tight">
        ...
        <div className="relative w-full flex justify-center items-center min-h-[400px]">
          <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="relative w-full max-w-[90vw] md:w-[750px] lg:w-[850px] h-[220px] md:h-[300px] bg-gradient-to-br from-slate-900 to-black rounded-2xl border border-amber-500/50 flex shadow-2xl overflow-hidden z-10">
                  ...
                  <div className="w-16 md:w-32 border-r-2 border-dashed border-amber-500/30 flex flex-col items-center justify-center bg-slate-950/50 relative shrink-0">
                    <span className="-rotate-90 text-amber-500/60 font-mono text-[10px] md:text-sm tracking-[0.3em] whitespace-nowrap absolute">
                      ADMIT ONE
                    </span>
                  </div>
                  ...
                  <div className="flex-1 p-6 md:p-10 flex flex-col justify-between relative">
                    ...
                    <div>
                      <div className="text-[10px] md:text-xs text-amber-300 uppercase tracking-widest font-semibold">
                        Youth Innovation Leadership Project
                      </div>
                    ...
                    <div className="flex justify-between items-end border-t border-amber-500/20 pt-4 mt-2">
                      <div className="flex flex-col">
                        <span className="text-[9px] md:text-[10px] text-slate-500 uppercase tracking-wider">
                          Date
                        </span>
                        <span className="text-xs md:text-sm text-amber-100 font-mono">
                          DEC 2025
                        </span>
                      </div>
            ...
            {/* VIEW 2: THE LETTER (Teacher Easter Egg) */}
            {viewState === 'letter' && (
              <motion.div
                key="letter"
                ...
                <div className="p-8 md:p-10 space-y-8">
                  ...
                  <div className="text-center space-y-3 border-b border-white/5 pb-8">
                    ...
                    <p className="text-sm text-slate-400 leading-relaxed max-w-sm mx-auto">
                      我们五个小组认真开过会，也认真摸过鱼，综合研判之后得出一个一致结论：
                      继续设计终面已经没有必要——因为我们早就被您“特招录用”进青年创新领袖计划了。
                    </p>
                  </div>
                      ...
                      <div className="flex items-start gap-5">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-slate-400 leading-relaxed">
                            ...
                            但在多轮和您上课、做展示与做项目之后，我们集体决定：
                            把所有流程简化成一句话——
                            <span className="text-amber-200">“我们已经被您成功收编，特此备案。”</span>
                            这份 Golden Ticket 只是想正式声明：感谢您对青年创新领袖计划的付出，五个小组都非常珍惜在您的带领下参与本项目的机会，
                            接下来我们将继续进步，在课堂上呈现出更好的表现。
                            希望这个小彩蛋能让您在看方案的间隙微微一笑。
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex justify-between items-center pt-2 text-[10px] text-slate-500 font-mono uppercase tracking-wider">
                    ...
                    <span>DEC 2025 · Youth Innovation Leadership Project</span>
                  </div>
